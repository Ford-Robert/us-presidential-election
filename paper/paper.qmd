---
title: "Forecasting the United States 2024 Presidential Election Using State as Fixed Effect Through a Bayesain Approach"
...
- **Support**  
  *Definition:* The support level for candidate in a given poll.  
  *Justification:* Measures the proportion of respondents supporting candidate, providing insight into their current standing.

- **Sample Size**  
  *Definition:* Represents the number of respondents in poll.  
  *Justification:* Larger sample sizes generally yield more accurate estimates of support, reducing sampling variability.

- **Days to election**  
  *Definition:* Denotes the number of days remaining until the election when poll was conducted.  
...
where \(N\) is the number of polls for state.
...
# Create the table
kable(compact_df, col.names = c("State", "Last Time Voted for a Different Party",
